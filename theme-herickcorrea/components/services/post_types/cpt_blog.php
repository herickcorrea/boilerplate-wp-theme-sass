...
function custom_post_blog()
{
  ...
  $args = array(
    ...
    'description'           => __( 'Postagens do Blog Ed21', 'text_domain' ),
    'labels'                => $labels,
    'supports'              => array( 'title', 'editor', 'thumbnail', 'comments', 'trackbacks', 'revisions', 'custom-fields', 'excerpt' ),
    'taxonomies'            => array( 'category_blog', 'post_tag_blog' ),
    'hierarchical'          => false,
    'public'                => true,
    'show_ui'               => true,
    'show_in_menu'          => true,
...
function custom_blog_tag() {
  ...
  register_taxonomy( 'post_tag_blog', array( 'post_blog' ), $args );

}
add_action( 'init', 'custom_blog_tag', 0 );

// Register Custom Taxonomy
function custom_blog_taxonomy() {
	...
	register_taxonomy( 'category_blog', array( 'post_blog' ), $args );

}
add_action( 'init', 'custom_blog_taxonomy', 0 );