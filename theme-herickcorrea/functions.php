...
function twentytwenty_menus() {
	...
	$locations = array(
		'primary'  => __( 'Top Menu', 'twentytwenty' ),
		'sitemap_c01'   => __( 'Sitemap Col 1', 'twentytwenty' ),
		'sitemap_c02'   => __( 'Sitemap Col 2', 'twentytwenty' ),
		'sitemap_c03'   => __( 'Sitemap Col 3', 'twentytwenty' ),
		'sitemap_c04'   => __( 'Sitemap Col 4', 'twentytwenty' ),
	);
...
function wp_67472455() {
   wp_dequeue_style( 'gglcptch-css' );
}
add_action( 'wp_print_styles', 'wp_67472455');
...
add_action( 'wp_enqueue_scripts', 'regScriptsAndCSS' );

add_filter( 'script_loader_tag', function ( $tag, $handle, $src )
{
	switch ( $handle )
	{
		case 'scripts-template':
...
{
	return get_stylesheet_directory_uri().'/static'. $objeto;
}

function svg($fileName, $atributos = array(), $print = true)
{
    $output = NULL;
	$includeFile = get_theme_file_path().'/static/images/svg/'. $fileName.'.php';
...
function import_component($componente, $props = array())
{
    $output = NULL;
	$includeFile = get_theme_file_path(). $componente.'.php';
